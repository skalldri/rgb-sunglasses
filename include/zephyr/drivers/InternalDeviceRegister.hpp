...
template <const char *name, size_t firstBit, size_t bitWidth>
class RegisterField
{
...
template <const char *name, size_t firstBit, size_t bitWidth>
struct is_RegisterField<RegisterField<name, firstBit, bitWidth>> : std::true_type
{
};
...
private:
    ...
    inline void dumpHelper()
    {
        ...
        LOG_INF("\t%s: %u", T::getName(), this->template getRegFieldFromStorage<T>());
    }
