...
simulator binary on a self-hosted macOS runner (`build-ios` job in `.github/workflows/app-ci.yml`)
with `CODE_SIGNING_ALLOWED=NO` — no Apple Developer account or signing secrets.
