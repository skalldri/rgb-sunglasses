...
USBD_DEVICE_DEFINE(rgb_sunglasses_usbd, DEVICE_DT_GET(DT_NODELABEL(zephyr_udc0)),
...
USBD_DESC_PRODUCT_DEFINE(usb_product, CONFIG_APP_USB_PRODUCT_STRING);
...
static int usb_init(void) {
    ...
    err = usbd_device_set_code_triple(&rgb_sunglasses_usbd, USBD_SPEED_FS, USB_BCC_MISCELLANEOUS,
                                      0x02, 0x01);
    if (err) {
