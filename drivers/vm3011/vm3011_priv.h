...
using VM3011_I2C_CNTRL =
    VM3011Register<I2C_CNTRL_NAME, VM3011_REG_I2C_CNTRL_ADDR, 8, VM3011_I2C_CNTRL_WDT_ENABLE,
                   VM3011_I2C_CNTRL_WDT_DLY, VM3011_I2C_CNTRL_DOUT_CLEAR>;
...
using VM3011_WOS_PGA_GAIN = VM3011Register<WOS_PGA_GAIN_NAME, VM3011_REG_WOS_PGA_GAIN_ADDR, 8,
...
using VM3011_WOS_FILTER = VM3011Register<WOS_FILTER_NAME, VM3011_REG_WOS_FILTER_ADDR, 8,
                                         VM3011_WOS_FILTER_WOS_LPF, VM3011_WOS_FILTER_WOS_HPF>;
...
using VM3011_WOS_PGA_MIN_THR =
    VM3011Register<WOS_PGA_MIN_THR_NAME, VM3011_REG_WOS_PGA_MIN_THR_ADDR, 8,
                   VM3011_WOS_PGA_MIN_THR_WOS_PGA_MIN_THR, VM3011_WOS_PGA_MIN_THR_FAST_MODE_CNT>;
...
using VM3011_WOS_PGA_MAX_THR =
    VM3011Register<WOS_PGA_MAX_THR_NAME, VM3011_REG_WOS_PGA_MAX_THR_ADDR, 8,
                   VM3011_WOS_PGA_MAX_THR_WOS_PGA_MAX_THR, VM3011_WOS_PGA_MAX_THR_WOS_RMS>;
...
using VM3011_WOS_THRESH =
    VM3011Register<WOS_THRESH_NAME, VM3011_REG_WOS_THRESH_ADDR, 8, VM3011_WOS_THRESH_WOS_THRESH>;
